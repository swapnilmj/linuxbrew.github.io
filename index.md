...
Features, usage and installation instructions are [summarised on the homepage](http://linuxbrew.sh#features). Terminology (e.g. the difference between a Cellar, Tap, Cask and so forth) is [explained here](http://docs.brew.sh/Formula-Cookbook.html#homebrew-terminology).
